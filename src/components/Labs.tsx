  ...
  const labs: Lab[] = [
    {
      ...
      description: 'Learn fundamentals of network packet analysis using Wireshark',
      difficulty: 'Beginner',
      category: 'Network Security',
      icon: Network,
      link: 'https://example.com/lab1',
    ...
    },
    {
      ...
      description: 'Explore basic encryption and decryption techniques',
    ...
    },
    {
      ...
      description: 'Learn to identify and exploit buffer overflow vulnerabilities',
      difficulty: 'Advanced',
    ...
    },
    {
      ...
      description: 'Analyze digital evidence and recover deleted files',
      difficulty: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Static analysis techniques for malware samples',
      difficulty: 'Advanced',
